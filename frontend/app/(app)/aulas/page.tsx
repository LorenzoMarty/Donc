...
import { apiFetch, type Subject } from "@/lib/api";
  ...
  return (
    <MotionShell className="space-y-6">
      <PageHeader
        ...
        description="Modulos curtos, progresso visivel e pratica conectada a cada habilidade."
      />
                ...
                <Surface key={module.id}>
                  ...
                  <div className="grid gap-3">
                    {module.lessons.map((lesson) => (
                      <Link key={lesson.id} href={`/aulas/${lesson.id}`} className="group grid gap-3 rounded-md border p-3 transition-colors hover:bg-muted md:grid-cols-[120px_1fr_auto]">
                        <img src={lesson.thumbnail_url} alt="" className="h-20 w-full rounded-md object-cover md:w-[120px]" />
