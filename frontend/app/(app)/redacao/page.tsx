...
import { AlertCircle, Brain, CheckCircle2, FilePenLine, Lightbulb, Sparkles } from "lucide-react";
...
export default function EssayPage() {
  ...
  return (
    <div className="space-y-5 md:space-y-6">
      <PageHeader
        eyebrow="Studio de redacao"
        title="Escreva com foco. Evolua com IA."
        description="Um ambiente limpo para produzir, revisar e transformar feedback em proxima acao."
        action={
          <Button onClick={() => createDraft()} disabled={!selectedTheme} size="lg" className="w-full md:w-auto">
