    ...
    <main className="grid min-h-screen bg-background lg:grid-cols-[1fr_0.9fr]">
      ...
      <section className="hidden border-l bg-card lg:block">
        <div
          ...
          style={{ backgroundImage: "linear-gradient(180deg, rgba(15,76,92,.15), rgba(31,41,51,.82)), url('https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?auto=format&fit=crop&w=1400&q=80')" }}
        >
            <div className="max-w-lg text-white">
              <p className="mb-3 text-sm font-semibold text-secondary">Redacao, dados e IA</p>
            <h2 className="text-4xl font-black tracking-normal">Estudo guiado para evoluir com clareza.</h2>
            <p className="mt-4 text-sm leading-6 text-white/82">Acompanhe competencias, rotina, simulados e feedbacks em uma experiencia unica.</p>
          </div>
        </div>
      </section>
    </main>
