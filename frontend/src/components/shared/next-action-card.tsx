  ...
  return (
    <div className="flex items-center justify-between gap-6 rounded-card bg-card p-6 shadow-soft">
      <div className="min-w-0 max-w-2xl">
        <p className="text-[13px] font-semibold uppercase tracking-[0.14em] text-primary">Seu próximo treino</p>
      ...
      <Link
        ...
        className="flex h-11 shrink-0 items-center gap-2 rounded-control bg-primary px-5 text-[14px] font-bold text-primary-foreground transition-colors hover:bg-primary/90"
      >
        Começar
