...
import { SupportTicketsTab } from "./_tabs/support-tickets";
...
const NAV_TABS: AdminTab[] = [
  ...
  { value: "support-tickets", label: "Suporte", description: "Chamados abertos pelos alunos.", section: "Operação", icon: LifeBuoy },
