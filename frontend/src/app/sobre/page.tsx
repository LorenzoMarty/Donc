      ...
      <main className="mx-auto max-w-7xl px-4 py-10 md:px-6">
        <AceternityGrid className="rounded-[2rem] p-6 md:p-10">
          <Reveal className="max-w-4xl">
            <p className="text-xs font-black uppercase text-primary">Sobre</p>
            <h1 className="mt-3 text-4xl font-black tracking-normal md:text-6xl">Donk ENEM existe para transformar estudo em sensação real de progresso.</h1>
