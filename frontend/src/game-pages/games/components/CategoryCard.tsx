    ...
    >
      ...
      >
        ...
        <div className="relative flex items-start justify-between gap-4">
          ...
          <div className="grid h-9 w-9 place-items-center rounded-md border border-border bg-card text-muted-foreground transition-all duration-300 group-hover:border-primary/35 group-hover:text-secondary">
        ...
        <div className="relative mt-6 space-y-2">
          <div className="flex items-center justify-between gap-3 text-xs font-semibold">
            ...
            <span className="text-secondary">{category.progress}% dominado</span>
          </div>
