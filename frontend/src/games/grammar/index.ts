    ...
    questions: [
      {
        ...
        options: [
          "Os jovens precisa de orientacao critica.",
          "A escola deve mediar leituras.",
          "As redes influenciam habitos.",
      ...
      },
      {
        ...
        options: [
          "Ao analisar o problema percebe-se a falha.",
          "A escola amplia repertorios.",
          "O governo investe em leitura.",
          "Jovens acessam redes sociais.",
        ],
        answerIndex: 0,
    ...
    questions: [
      {
        ...
        options: [
          "Nesse contexto, a escola deve atuar.",
          "Nesse contexto a escola, deve atuar.",
          "Nesse, contexto a escola deve atuar.",
          "Nesse contexto a escola deve, atuar.",
        ],
