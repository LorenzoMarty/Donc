...
from src.models import Achievement, Course, Essay, Exercise, ExerciseAnswer, Goal, Lesson, LessonProgress, MockExamAttempt, Module, User, UserAchievement
from src.schemas.dashboard import AchievementRead, DashboardResponse, GoalRead, PendingExercise, RecentExam, RecentLesson, TrendPoint
