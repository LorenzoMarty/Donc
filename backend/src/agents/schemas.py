...
class EssayThemeTitleSuggestionsResult(BaseModel):
...
class GameGenerationResult(BaseModel):
    ...
    # count=1 — jogos nao sao mais criados via IA (so perguntas/conteudo adicionados a jogos ja
    # existentes), entao nao ha mais validacao de minimo por "jogo completo" aqui.
