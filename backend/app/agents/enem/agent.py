...
from app.agents.correction.fallback import FallbackCorrectionProvider
from app.agents.schemas import ENEMCompetencyAnalysis, GrammarAnalysis, RepertoireAnalysis, ThesisAnalysis
from app.prompts.agent_instructions import ENEM_COMPETENCY_INSTRUCTIONS
